...
export class DocumentsListComponent implements OnInit, OnDestroy {
    ...
    private isLastRouteRelated() {
        ...
        if (this.url === this.menuService.routePaths.complaintItems ||
            this.url === this.menuService.routePaths.pending) {
            return this.isLastRoute(this.menuService.routePaths.itemDetails);
        } else {
