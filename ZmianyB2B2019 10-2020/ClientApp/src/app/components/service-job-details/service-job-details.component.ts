import { Component, OnInit, ViewEncapsulation, ChangeDetectorRef, ChangeDetectionStrategy, TemplateRef, ViewChild } from '@angular/core';
...
export class ServiceJobDetailsComponent implements OnInit {
