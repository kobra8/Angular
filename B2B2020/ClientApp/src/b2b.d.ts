...
import { b2bCartHeader } from './integration/b2b-cart-header';
...
export module b2b {
    ...
    */
    interface ProductsResponse {
        ...
        products: ProductListElementResponse[];
    }
    ...
    */
    interface PricesResponse {
        items: PricesItemsResponse;
        thresholdPriceLists: b2bProductDetails.ThresholdPriceLists;
    }

    interface ConvertedAsyncPricesResponse {
        items: ConvertedPricesResponse;
        thresholdPriceLists: b2bProductDetails.ThresholdPriceLists;
    }

    interface PricesItemsResponse {
        outputs?: { returN_VALUE: number };
    ...
    */
    interface CartHeader {
        ...
        fromQuote?: number;
        quoteNumber?: string;
        shippingAddress?: b2bCartHeader.ShippingAddressXl;
    }
   ...
   */
    ...
    */
    ...
    interface QuoteDetailsBase extends CustomerListDetailsResponse {
        set1: any[];
        set2: Attachement[];
        set3: any[];
        set4: QuoteDetails[];
    ...
    interface OrderProduct extends CustomerListProduct, CartItemDescription {
    ...
    interface OrderDetailsResponse extends CustomerListDetailsResponse {
        ...
        */
        set7: IDs[];
        set8: OrderDetailsValidation;
    }

    interface OrderDetailsValidation {
