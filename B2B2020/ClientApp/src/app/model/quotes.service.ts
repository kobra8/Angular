...
export class QuotesService extends DocumentsList {
    ...
    addToCartFromQuote(request: b2bQuotes.AddToCartFromQuoteRequest): Promise<b2bQuotes.AddToCartFromQuoteResponse> {
        return this.httpClient.post<b2bQuotes.AddToCartFromQuoteResponse>('/api/Quotes/addCartFromQuote', request).toPromise();
    }
