...
export class ServiceJobDetailsService extends NewDocumentDetails<b2b.ServiceJobDetails> {
    ...
    constructor(httpClient: HttpClient, configService: ConfigService, printHandlerService: PrintHandlerService) {
        super(httpClient, configService, printHandlerService);
    ...
    print() {
        return super.print(DocumentType.serviceJob, this.id);
    }
}
